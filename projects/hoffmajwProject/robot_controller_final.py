...
import time
import math
import hoffmajw_finalproject_ev3 as jax
...
class Snatch3r(object):
    ...
    def unplugged(self):
        """Checks to see if the motors are connected or not, if not an error
           will be thrown"""
        try:
    ...
    def getCheeseburgers(self):
        jax.getCheeseburgers(self)
    ...
    def seek_beacon(self):
        """ Looks for a nearby beacon with the ir sensor and drives to the
            ...
            true if the beacon is found and false if the beacon is not in
            range."""
    ...
    def leaveGrocery(self):
        jax.leaveGrocery(self)
