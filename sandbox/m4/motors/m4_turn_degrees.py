...
# Done 3. Create a method in your library called turn_degrees that receives the
#  degrees_to_turn and turn_speed_sp
...
# Done 4. Individually implement the code here to use your turn_degrees library
#  method.
...
# Done 5. Formally test your work. When you think you have the problem complete
#  run these tests:
