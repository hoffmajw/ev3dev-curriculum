...
Much like we did in hoffmajw of the motors unit, later we will show you different (better) ways to use buttons.
...
def main():
    ...
    led_colors = [ev3.Leds.GREEN, ev3.Leds.RED, ev3.Leds.AMBER, ev3.Leds.BLACK]
